...
class WeaponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post weapons_url, params: { weapon: { category: @weapon.category, cost: @weapon.cost, damage: @weapon.damage, name: @weapon.name, weight: @weapon.weight } }
    end
  ...
  test "should update weapon" do
    patch weapon_url(@weapon), params: { weapon: { category: @weapon.category, cost: @weapon.cost, damage: @weapon.damage, name: @weapon.name, weight: @weapon.weight } }
